      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 w-full">
        <div className="max-w-3xl">
          ...
          >
            ...
            <a href={`tel:${COMPANY_PHONE.replace(/\s+/g, '')}`} className="flex items-center justify-center gap-2 px-6 py-3 md:px-8 md:py-4 bg-emerald text-white rounded-lg font-medium shadow-lg shadow-emerald/40 hover:bg-emerald-600 transition-all sm:hidden">
              <Phone size={20} />
              Call Now
            </a>
          </motion.div>
